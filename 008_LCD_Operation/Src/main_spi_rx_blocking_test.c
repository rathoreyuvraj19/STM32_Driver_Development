...
static uint8_t cmd_data[] = {0x20};
const static char strings[] = "Yo yoyo yoa syd agsd ";
...
void EXTI0_IRQHandler(void){
	...
	//SPIx_SendData_Blocking(SPI1, &x, 1);
	uint8_t size = sizeof(strings);
	//SPIx_SendData_Blocking(SPI1, &size, 1);
	//SPIx_SendData_Blocking(SPI1, (uint8_t*)strings, sizeof(strings));
	SPIx_SendData_Blocking(SPI1, (uint8_t*)cmd_data, sizeof(cmd_data));
	//SPIx_SendData_Blocking(SPI1, &x, 1);
	//x++;
	SPIx_ReceiveData_Blocking(SPI1, &rx_data, 1);
